...
int posicio1 = 20;   // posició servo dits en repos
int posicio2 = 100;  // posició servo dits agarre
...
void setup() 
{
    Serial.begin(9600);  // inici comuniació sèrie
...
{   
    ...
    { 
      dada_rebuda = Serial.read();  // Definir el valor de la variable com el del que es rebi pel port sèrie
